...
$co = "First Cutoff";
if ((date("D",strtotime("+8 Hours")) == "Sat") || (date("D",strtotime("+8 Hours")) == "Sun")) $co = "End of the day";
//if (date("D",strtotime("+8 Hours")) == "Fri") $co = "End of the day";
...
<td>Date:</td><td><input type="text" id="fdate" size="10" class="highlight" value="<?php echo date("m/d/Y",strtotime("+8 Hours")); ?>" /></td>
