...
<title>Stocks Returned to Companies - Summary</title>
<style type="text/css">
* {
	margin: 0;
	padding: 0;
...
<script type="text/javascript" src="js/stock-return.js"></script>
<script type="text/javascript">
$(function() {

var m = 'modules/stock-return.php';
var f = function() {
	$('#search').button();
	$('#search').click(function() { filterReturnStock(); });
