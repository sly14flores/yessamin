...
<script type="text/javascript" src="js/remittance.js"></script>
<script type="text/javascript">
$(function() {

var m = 'modules/remittance.php';
var f = function() {
	$('#add').button();
	$('#edit').button();
	$('#delete').button();
	$('#search').button();	
	$('#search').click(function() { filterRemittance(); });
