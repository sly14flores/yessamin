...
<script type="text/javascript" src="js/avon-category.js"></script>
<script type="text/javascript">
$(function() {

var m = 'modules/avon-category.php';
var f = function() {
	$('#add').button();
	$('#add').click(function() { avonCat(1,0); });
	$('#search').button();
	$('#search').click(function() { filterAvonCat(); });
